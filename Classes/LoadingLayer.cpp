...
bool LoadingLayer::init(){
	...
	{   
		...
		arminstance->removeArmatureFileInfo("soldier/"+ fileName + "/" + fileName + ".ExportJson");
	...
	{ 
		std::string fileName = (*it) + "NewAnimation";
		arminstance->addArmatureFileInfoAsync("soldier/"+ fileName + "/" + fileName + ".ExportJson",this,schedule_selector(LoadingLayer::update));
		auto file = "soldier/"+ fileName + "/" + fileName + ".ExportJson";
