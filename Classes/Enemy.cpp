...
bool Enemy::init(std::string str,float hp,float speed,float money){
	...
	this->setContentSize(amt->getContentSize());
...
void Enemy::dieAnimate(){
	...
	if(this->getProperty()==ICE){
		SimpleAudioEngine::getInstance()->playEffect("Music/die1.mp3");
	}else if(this->getProperty()==FIRE){
		SimpleAudioEngine::getInstance()->playEffect("Music/die2.mp3");
	}else if(this->getProperty()==WIRE){
		SimpleAudioEngine::getInstance()->playEffect("Music/die3.mp3");
	}else if(this->getProperty()==WIND){
		SimpleAudioEngine::getInstance()->playEffect("Music/die4.mp3");
	}
