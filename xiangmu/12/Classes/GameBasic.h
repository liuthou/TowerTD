...
#define ARROWATK 40.0f
#define BIGARROWATK 80.0f
#define THUNDERSKILL 40.0f/60.0f //pre second
#define DOUBLETHUNDER 80.0f/60.0f
#define YELLOWTHUNDER 100.0f/60.0f
#define FIRESKILL 60.0f
#define ICESKILL 50.0f
#define WINDSKILL 100.0f/60.0f
#define BONESKILL 80.0f
//superskill type
#define SUPERSKILLATK 200.0f/60.0f
#endif // !__GAMEBASIC_H
