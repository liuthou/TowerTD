...
bool SelectTowerLayer::init()
{
	...
	for (int i = 0; i < nums; i++)
	{
		...
		MenuItemImage* towerItem = MenuItemImage::create(StringUtils::format("tower__%02d.png", tower_count), StringUtils::format("tower__%02d.png", tower_count), StringUtils::format("tower__%02dunabled.png", tower_count), [=](Ref*)
		{			
