...
bool LevelLayer::init()
{
	...
	Widget * uilayer = GUIReader::getInstance()->widgetFromJsonFile("NewUiMenu_1.json");
...
{	
	...
	Widget* uiLayer =GUIReader::getInstance()->widgetFromJsonFile("NewUiProject_1.json");
	uiLayer->setAnchorPoint(Vec2(0.5f,0.5f));
	uiLayer->setPosition(Vec2(WINDOW_WIDTH/2,WINDOW_HEIGHT/2));
	layer->addChild(uiLayer);
	Widget* uiLayer2 =GUIReader::getInstance()->widgetFromJsonFile("NewUiProject_5.json");
	...
	Widget* uiLayer3 =GUIReader::getInstance()->widgetFromJsonFile("NewUiProject_3.json");
...
void LevelLayer::introduceTower()
{
	...
	Widget* bg3 =GUIReader::getInstance()->widgetFromJsonFile("NewUiProject_4.json");
	bg3->setAnchorPoint(Vec2(0.5f,0.5f));
	bg3->setPosition(Vec2(WINDOW_WIDTH/2,WINDOW_HEIGHT/2));
	layer->addChild(bg3);

	Widget* bg1 =GUIReader::getInstance()->widgetFromJsonFile("NewUiProject_6.json");
	bg1->setAnchorPoint(Vec2(0.5f,0.5f));
	bg1->setPosition(Vec2(-(WINDOW_WIDTH)+bg3->getPositionX(),WINDOW_HEIGHT/2));
    layer->addChild(bg1);

	Widget* bg2 =GUIReader::getInstance()->widgetFromJsonFile("NewUiProject_7.json");
...
void LevelLayer::About()
{
	...
	*/
	...
	Widget* uiLayer =GUIReader::getInstance()->widgetFromJsonFile("NewUiAbout_1.json");
    uiLayer->setAnchorPoint(Vec2(0.5f,0.5f));
	uiLayer->setPosition(Vec2(WINDOW_WIDTH/2,WINDOW_HEIGHT/2));
	layer->addChild(uiLayer);

	Widget* bg1 =GUIReader::getInstance()->widgetFromJsonFile("NewUiAbout_2.json");
	bg1->setAnchorPoint(Vec2(0.5f,0.5f));
	bg1->setPosition(Vec2(-(WINDOW_WIDTH)+uiLayer->getPositionX(),WINDOW_HEIGHT/2));
	layer->addChild(bg1);

	Widget* bg2 =GUIReader::getInstance()->widgetFromJsonFile("NewUiAbout_3.json");
	bg2->setAnchorPoint(Vec2(0.5f,0.5f));
