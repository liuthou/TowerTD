...
{
    SoundUtil::getInstance()->setIsBackGroundSound(_configValueMap[CONFIGBACKGROUND].asBool());
    SoundUtil::getInstance()->setIsEffectSound(_configValueMap[CONFIGEFFECTSOUND].asBool());
}
