...
bool InjuredEffect::init(){
    ...
    center->addObserver(this,callfuncO_selector(InjuredEffect::openAlarm), NOTIFICATIONCENTER_TO_OPEN_ALARM, nullptr);
    center->addObserver(this,callfuncO_selector(InjuredEffect::coloseAlarm), NOTIFICATIONCENTER_TO_COLOSE_ALARM, nullptr);
	return true;
}
void InjuredEffect::openAlarm(Ref *sender){
    beInjured(10, 5);
}
void InjuredEffect::coloseAlarm(Ref *sender){
    beInjured(10, 10);
}
